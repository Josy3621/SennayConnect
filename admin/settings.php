  ...
  <div class="wrapper">
    ...
    if (isset($_POST['publise'])) {
      ...
      if ($edit == '') {
        ...
        $insertdata = mysqli_query($con, "UPDATE settings SET site_name='$site_name',phone='$phone',email='$email',footer_desc='',address='$address',city='',state='',country='',pin='',header_logo='',footer_logo='',facebook='$facebook',twitter='$twitter',linkedin='$linkedin',instagram='$instagram',youtube='$youtube',map='$map' where id=" . $edit . "");
        $_SESSION['stutes'] = "Updated Successfully";
      }
    }
            ...
            <div class="col-md-6">
              ...
              <div class="card card-outline card-info">
                ...
                <div class="card-header">
                  <div class="form-group">
                    <label>Map</label>
                    <textarea name="map" class="form-control" placeholder="Enter The Location">
                    <?php $roww["map"]; ?>
                </textarea>
                  </div>
                </div>
