...
//fetch blogs 
$service = mysqli_query($con, "SELECT * FROM services_ngo WHERE id=$id");
$fetch = mysqli_fetch_array($service);


//fetch recent post
$recent = mysqli_query($con, "SELECT * FROM services_ngo ORDER BY id DESC");
                ...
                <div class="content-box">
                    <div class="content-wrapper">
                        ...
                        <ul class="bread-crumb clearfix">
                            ...
                            <li><a href="service_ngo.php">NGO Service</a></li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="news-block-four blog-single-post">
                            <div class="inner-box">
                                <div class="image mb-5"><img src="admin/images/services_ngo/<?php echo $fetch['img'];  ?>" alt=""></div>
                            ...
                            <div class="widget widget_categories">
                                ...
                                <div class="widget-content">
                                    <ul class="categories-list clearfix">
                                        ...
                                        ?>
                                            <li><a href="single-service_ngo.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?> <i class="flaticon-right-arrow-6"></i> <span><?php echo $counti; ?></span></a></li>
                                        <?php  } ?>
                                    </ul>
                                </div>
                            </div>
