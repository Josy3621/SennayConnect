                    ...
                    <div class="tab-content wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                            ...
                            <ul class="accordion-box style-two mb-30">
                                ...
                                ?>
                                    ...
                                    <li class="accordion block">
                                        <div class="acc-btn">
                                            <div class="icon-outer"><span class="icon icon_plus far fa-plus"></span> <span class="icon icon_minus far fa-plus "></span></div><strong><?php echo $i; ?>.</strong> <?php echo $row['title']; ?>
                                        </div>
                        ...
                        <div class="tab-pane fadeInUp animated" id="tab-two" role="tabpanel" aria-labelledby="tab-two">
                            <ul class="accordion-box style-two mb-30">
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><span class="icon icon_plus far fa-plus"></span> <span class="icon icon_minus far fa-plus "></span></div><strong>01.</strong> What warranties do i have for my shipments?
                                    </div>
                                    <div class="acc-content">
                                        <div class="content">
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn active">
                                        <div class="icon-outer"><span class="icon icon_plus far fa-plus"></span> <span class="icon icon_minus far fa-plus "></span></div><strong>02.</strong> What is included in your service?
                                    </div>
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><span class="icon icon_plus far fa-plus"></span> <span class="icon icon_minus far fa-plus "></span></div><strong>03.</strong> What are the usual methods of freight payment in transida?
                                    </div>
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">Equal blame belongs to those who fail in their duty through weaknes of will which is the same as saying through shrinking from toil and <br> pain. These cases are perfectly simple and easy to distinguish.
                                ...
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        <div class="icon-outer"><span class="icon icon_plus far fa-plus"></span> <span class="icon icon_minus far fa-plus "></span></div><strong>04. </strong> Can i get payment terms?
                                    </div>
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">Equal blame belongs to those who fail in their duty through weaknes of will which is the same as saying through shrinking from toil and <br> pain. These cases are perfectly simple and easy to distinguish.
