                            ...
                            <div class="widget links-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="list">
                                        ...
                                        <li><a href="service-all.php">Our Services</a></li>
...
<div class="footer-bottom">
    <div class="auto-container">
        <div class="row m-0 align-items-center justify-content-between">
            <div class="copyright-text">Copyright © 2022 <?php echo $setting['site_name']; ?> | Designed By <a target="blank" href="https://josy3621.netlify.app"> YG Solution</a></div>
